...
//	public String clientPort = "8201";
	public String clientFilePath = "/home/HVDC_iec61850/iec61850_client_server/";
//	public String IedConfigFile = "/home/HVDC_iec61850/iec61850_client_server/genad_stat_ied.txt";
	public String dataUploadDir = "/home/HVDC_iec61850/hvdcData/pd/";
...
//	public String clientAliveCommand = "ps -ef | grep iec61850_client_server | grep " + clientPort + " | grep -v grep";
	...
	public String RealTime_SumFile = "/home/HVDC_iec61850/RealTime_SumFile.sh";
}
